...
// ===== Expanded question bank (added) =====
{
  id: "dt1",
  title: "Interpret a distance\u2013time segment (1)",
  prompt: "<p>A distance\u2013time graph has a straight segment from \\(t=0\\) to \\(t=4\\) s where distance increases from 0 m to 12 m.</p><p>(a) Calculate the speed.</p><p>(b) Describe the motion.</p>",
  answer: "<p>(a) Speed \\(=\\frac{12-0}{4-0}=3\\text{ m s}^{-1}\\).</p><p>(b) Constant speed away from the start.</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
  marks: 3,
  skills: ["slope", "interpretation"]
},

{
  id: "dt2",
  title: "Interpret a distance\u2013time segment (2)",
  prompt: "<p>A distance\u2013time graph has a straight segment from \\(t=0\\) to \\(t=4\\) s where distance increases from 0 m to 12 m.</p><p>(a) Calculate the speed.</p><p>(b) Describe the motion.</p>",
  answer: "<p>(a) Speed \\(=\\frac{12-0}{4-0}=3\\text{ m s}^{-1}\\).</p><p>(b) Constant speed away from the start.</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dt3",
  title: "Interpret a distance\u2013time segment (3)",
  prompt: "<p>A distance\u2013time graph has a straight segment from \\(t=0\\) to \\(t=4\\) s where distance increases from 0 m to 12 m.</p><p>(a) Calculate the speed.</p><p>(b) Describe the motion.</p>",
  answer: "<p>(a) Speed \\(=\\frac{12-0}{4-0}=3\\text{ m s}^{-1}\\).</p><p>(b) Constant speed away from the start.</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dt4",
  title: "Interpret a distance\u2013time segment (4)",
  prompt: "<p>A distance\u2013time graph has a straight segment from \\(t=0\\) to \\(t=4\\) s where distance increases from 0 m to 12 m.</p><p>(a) Calculate the speed.</p><p>(b) Describe the motion.</p>",
  answer: "<p>(a) Speed \\(=\\frac{12-0}{4-0}=3\\text{ m s}^{-1}\\).</p><p>(b) Constant speed away from the start.</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dt5",
  title: "Interpret a distance\u2013time segment (5)",
  prompt: "<p>A distance\u2013time graph has a straight segment from \\(t=0\\) to \\(t=4\\) s where distance increases from 0 m to 12 m.</p><p>(a) Calculate the speed.</p><p>(b) Describe the motion.</p>",
  answer: "<p>(a) Speed \\(=\\frac{12-0}{4-0}=3\\text{ m s}^{-1}\\).</p><p>(b) Constant speed away from the start.</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dt6",
  title: "Interpret a distance\u2013time segment (6)",
  prompt: "<p>A distance\u2013time graph has a straight segment from \\(t=0\\) to \\(t=4\\) s where distance increases from 0 m to 12 m.</p><p>(a) Calculate the speed.</p><p>(b) Describe the motion.</p>",
  answer: "<p>(a) Speed \\(=\\frac{12-0}{4-0}=3\\text{ m s}^{-1}\\).</p><p>(b) Constant speed away from the start.</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dt7",
  title: "Interpret a distance\u2013time segment (7)",
  prompt: "<p>A distance\u2013time graph has a straight segment from \\(t=0\\) to \\(t=4\\) s where distance increases from 0 m to 12 m.</p><p>(a) Calculate the speed.</p><p>(b) Describe the motion.</p>",
  answer: "<p>(a) Speed \\(=\\frac{12-0}{4-0}=3\\text{ m s}^{-1}\\).</p><p>(b) Constant speed away from the start.</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dt8",
  title: "Interpret a distance\u2013time segment (8)",
  prompt: "<p>A distance\u2013time graph has a straight segment from \\(t=0\\) to \\(t=4\\) s where distance increases from 0 m to 12 m.</p><p>(a) Calculate the speed.</p><p>(b) Describe the motion.</p>",
  answer: "<p>(a) Speed \\(=\\frac{12-0}{4-0}=3\\text{ m s}^{-1}\\).</p><p>(b) Constant speed away from the start.</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dtrest1",
  title: "Rest interval on a distance\u2013time graph (1)",
  prompt: "<p>A distance\u2013time graph is horizontal from \\(t=6\\) s to \\(t=10\\) s.</p><p>What does this tell you about the object\u2019s motion in that interval?</p>",
  answer: "<p>The distance is not changing, so the object is <strong>at rest</strong> (speed \\(=0\\)).</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
  marks: 3,
...
{
  id: "dtrest2",
  title: "Rest interval on a distance\u2013time graph (2)",
  prompt: "<p>A distance\u2013time graph is horizontal from \\(t=6\\) s to \\(t=10\\) s.</p><p>What does this tell you about the object\u2019s motion in that interval?</p>",
  answer: "<p>The distance is not changing, so the object is <strong>at rest</strong> (speed \\(=0\\)).</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dtrest3",
  title: "Rest interval on a distance\u2013time graph (3)",
  prompt: "<p>A distance\u2013time graph is horizontal from \\(t=6\\) s to \\(t=10\\) s.</p><p>What does this tell you about the object\u2019s motion in that interval?</p>",
  answer: "<p>The distance is not changing, so the object is <strong>at rest</strong> (speed \\(=0\\)).</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dtrest4",
  title: "Rest interval on a distance\u2013time graph (4)",
  prompt: "<p>A distance\u2013time graph is horizontal from \\(t=6\\) s to \\(t=10\\) s.</p><p>What does this tell you about the object\u2019s motion in that interval?</p>",
  answer: "<p>The distance is not changing, so the object is <strong>at rest</strong> (speed \\(=0\\)).</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dtrest5",
  title: "Rest interval on a distance\u2013time graph (5)",
  prompt: "<p>A distance\u2013time graph is horizontal from \\(t=6\\) s to \\(t=10\\) s.</p><p>What does this tell you about the object\u2019s motion in that interval?</p>",
  answer: "<p>The distance is not changing, so the object is <strong>at rest</strong> (speed \\(=0\\)).</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "dtrest6",
  title: "Rest interval on a distance\u2013time graph (6)",
  prompt: "<p>A distance\u2013time graph is horizontal from \\(t=6\\) s to \\(t=10\\) s.</p><p>What does this tell you about the object\u2019s motion in that interval?</p>",
  answer: "<p>The distance is not changing, so the object is <strong>at rest</strong> (speed \\(=0\\)).</p>",
  category: "graphs-distance-time",
  difficulty: "foundation",
...
{
  id: "bus_story_1",
  title: "Walk \u2192 Wait \u2192 Bus (describe A\u2192B)",
  prompt: "<p>A person leaves home at 9:00, walks to a bus stop by 9:15, waits until 9:30, then takes a bus into town arriving 9:45.</p><p>The distance\u2013time graph has three segments: OA (up), AB (flat), BC (steep up).</p><p>(i) Describe what is happening from A to B.</p>",
  answer: "<p>From A to B the graph is flat, so distance stays the same: the person is <strong>waiting at the bus stop</strong> (not moving).</p>",
  category: "graphs-distance-time",
  difficulty: "standard",
  marks: 3,
  skills: ["interpretation"]
...
{
  id: "bus_story_2",
  title: "Walk \u2192 Wait \u2192 Bus (compare steepness)",
  prompt: "<p>Using the same walk\u2013wait\u2013bus journey, BC is much steeper than OA.</p><p>What does that tell you about the motion?</p>",
  answer: "<p>Steeper slope means greater speed. So the person travels <strong>faster</strong> on BC (on the bus) than on OA (walking).</p>",
  category: "graphs-distance-time",
  difficulty: "standard",
  marks: 3,
  skills: ["slope", "compare"]
},

{
  id: "bus_story_3",
  title: "Convert distance\u2013time to speed\u2013time",
  prompt: "<p>A distance\u2013time graph shows: </p><ul><li>0\u201315 min: distance rises linearly from 0 to 1 km</li><li>15\u201330 min: distance constant at 1 km</li><li>30\u201345 min: distance rises linearly from 1 km to 5 km</li></ul><p>Sketch the corresponding <strong>speed\u2013time</strong> graph.</p>",
  answer: "<p>Speed is slope:</p><ul><li>0\u201315 min: constant speed \\(=\\frac{1}{15}\\text{ km/min}\\)</li><li>15\u201330 min: speed \\(=0\\)</li><li>30\u201345 min: constant speed \\(=\\frac{4}{15}\\text{ km/min}\\) (larger)</li></ul><p>So the speed\u2013time graph is three horizontal sections at those values.</p>",
  category: "graphs-distance-time",
  difficulty: "challenge",
  marks: 3,
  skills: ["derive", "sketch"]
},

{
  id: "vt_area1",
  title: "Displacement from a v\u2013t graph (1)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
  marks: 3,
  skills: ["area"]
...
{
  id: "vt_area2",
  title: "Displacement from a v\u2013t graph (2)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_area3",
  title: "Displacement from a v\u2013t graph (3)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_area4",
  title: "Displacement from a v\u2013t graph (4)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_area5",
  title: "Displacement from a v\u2013t graph (5)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_area6",
  title: "Displacement from a v\u2013t graph (6)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_area7",
  title: "Displacement from a v\u2013t graph (7)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_area8",
  title: "Displacement from a v\u2013t graph (8)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_area9",
  title: "Displacement from a v\u2013t graph (9)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_area10",
  title: "Displacement from a v\u2013t graph (10)",
  prompt: "<p>An object moves with constant velocity \\(v=6\\text{ m s}^{-1}\\) for 8 s.</p><p>Find the displacement.</p>",
  answer: "<p>Displacement = area under v\u2013t = \\(6\\times 8 = 48\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_slope1",
  title: "Acceleration from a v\u2013t graph (1)",
  prompt: "<p>The velocity increases uniformly from \\(2\\text{ m s}^{-1}\\) to \\(10\\text{ m s}^{-1}\\) in 4 s.</p><p>Find the acceleration.</p>",
  answer: "<p>Acceleration = slope \\(=\\frac{10-2}{4}=2\\text{ m s}^{-2}\\).</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
  marks: 3,
  skills: ["slope"]
...
{
  id: "vt_slope2",
  title: "Acceleration from a v\u2013t graph (2)",
  prompt: "<p>The velocity increases uniformly from \\(2\\text{ m s}^{-1}\\) to \\(10\\text{ m s}^{-1}\\) in 4 s.</p><p>Find the acceleration.</p>",
  answer: "<p>Acceleration = slope \\(=\\frac{10-2}{4}=2\\text{ m s}^{-2}\\).</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_slope3",
  title: "Acceleration from a v\u2013t graph (3)",
  prompt: "<p>The velocity increases uniformly from \\(2\\text{ m s}^{-1}\\) to \\(10\\text{ m s}^{-1}\\) in 4 s.</p><p>Find the acceleration.</p>",
  answer: "<p>Acceleration = slope \\(=\\frac{10-2}{4}=2\\text{ m s}^{-2}\\).</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_slope4",
  title: "Acceleration from a v\u2013t graph (4)",
  prompt: "<p>The velocity increases uniformly from \\(2\\text{ m s}^{-1}\\) to \\(10\\text{ m s}^{-1}\\) in 4 s.</p><p>Find the acceleration.</p>",
  answer: "<p>Acceleration = slope \\(=\\frac{10-2}{4}=2\\text{ m s}^{-2}\\).</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_slope5",
  title: "Acceleration from a v\u2013t graph (5)",
  prompt: "<p>The velocity increases uniformly from \\(2\\text{ m s}^{-1}\\) to \\(10\\text{ m s}^{-1}\\) in 4 s.</p><p>Find the acceleration.</p>",
  answer: "<p>Acceleration = slope \\(=\\frac{10-2}{4}=2\\text{ m s}^{-2}\\).</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_slope6",
  title: "Acceleration from a v\u2013t graph (6)",
  prompt: "<p>The velocity increases uniformly from \\(2\\text{ m s}^{-1}\\) to \\(10\\text{ m s}^{-1}\\) in 4 s.</p><p>Find the acceleration.</p>",
  answer: "<p>Acceleration = slope \\(=\\frac{10-2}{4}=2\\text{ m s}^{-2}\\).</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_slope7",
  title: "Acceleration from a v\u2013t graph (7)",
  prompt: "<p>The velocity increases uniformly from \\(2\\text{ m s}^{-1}\\) to \\(10\\text{ m s}^{-1}\\) in 4 s.</p><p>Find the acceleration.</p>",
  answer: "<p>Acceleration = slope \\(=\\frac{10-2}{4}=2\\text{ m s}^{-2}\\).</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_slope8",
  title: "Acceleration from a v\u2013t graph (8)",
  prompt: "<p>The velocity increases uniformly from \\(2\\text{ m s}^{-1}\\) to \\(10\\text{ m s}^{-1}\\) in 4 s.</p><p>Find the acceleration.</p>",
  answer: "<p>Acceleration = slope \\(=\\frac{10-2}{4}=2\\text{ m s}^{-2}\\).</p>",
  category: "graphs-velocity-time",
  difficulty: "foundation",
...
{
  id: "vt_negative_1",
  title: "Signed area (negative displacement)",
  prompt: "<p>A v\u2013t graph is below the time-axis from \\(t=0\\) to \\(t=5\\) s with constant \\(v=-3\\text{ m s}^{-1}\\).</p><p>Find the displacement and explain the sign.</p>",
  answer: "<p>Displacement \\(=(-3)\\times 5 = -15\\) m. The negative sign means the object moves in the opposite direction to the chosen positive direction.</p>",
  category: "graphs-velocity-time",
  difficulty: "standard",
  marks: 3,
  skills: ["signed area"]
...
{
  id: "vt_piecewise_1",
  title: "Piecewise v\u2013t displacement + final speed",
  prompt: "<p>Velocity changes as follows:</p><ul><li>0\u20134 s: \\(v=5\\text{ m s}^{-1}\\)</li><li>4\u201310 s: decreases uniformly to \\(v= -1\\text{ m s}^{-1}\\)</li></ul><p>(a) Find the acceleration from 4\u201310 s.</p><p>(b) Find the displacement from 0\u201310 s.</p>",
  answer: "<p>(a) \\(a=\\frac{-1-5}{10-4}=\\frac{-6}{6}=-1\\text{ m s}^{-2}\\).</p><p>(b) Area: from 0\u20134: \\(5\\times 4=20\\) m. From 4\u201310: trapezium area \\(=\\frac{(5+(-1))}{2}\\times 6=\\frac{4}{2}\\times 6=12\\) m. Total \\(=32\\) m.</p>",
  category: "graphs-velocity-time",
  difficulty: "challenge",
  marks: 6,
  skills: ["trapezium", "piecewise"]
},

{
  id: "at_changev1",
  title: "Change in velocity from an a\u2013t graph (1)",
  prompt: "<p>An object has constant acceleration \\(a=1.5\\text{ m s}^{-2}\\) for 6 s.</p><p>Find the change in velocity.</p>",
  answer: "<p>Change in velocity = area under a\u2013t = \\(1.5\\times 6 = 9\\text{ m s}^{-1}\\).</p>",
  category: "graphs-acceleration-time",
  difficulty: "foundation",
  marks: 3,
  skills: ["area"]
...
{
  id: "at_changev2",
  title: "Change in velocity from an a\u2013t graph (2)",
  prompt: "<p>An object has constant acceleration \\(a=1.5\\text{ m s}^{-2}\\) for 6 s.</p><p>Find the change in velocity.</p>",
  answer: "<p>Change in velocity = area under a\u2013t = \\(1.5\\times 6 = 9\\text{ m s}^{-1}\\).</p>",
  category: "graphs-acceleration-time",
  difficulty: "foundation",
...
{
  id: "at_changev3",
  title: "Change in velocity from an a\u2013t graph (3)",
  prompt: "<p>An object has constant acceleration \\(a=1.5\\text{ m s}^{-2}\\) for 6 s.</p><p>Find the change in velocity.</p>",
  answer: "<p>Change in velocity = area under a\u2013t = \\(1.5\\times 6 = 9\\text{ m s}^{-1}\\).</p>",
  category: "graphs-acceleration-time",
  difficulty: "foundation",
...
{
  id: "at_changev4",
  title: "Change in velocity from an a\u2013t graph (4)",
  prompt: "<p>An object has constant acceleration \\(a=1.5\\text{ m s}^{-2}\\) for 6 s.</p><p>Find the change in velocity.</p>",
  answer: "<p>Change in velocity = area under a\u2013t = \\(1.5\\times 6 = 9\\text{ m s}^{-1}\\).</p>",
  category: "graphs-acceleration-time",
  difficulty: "foundation",
...
{
  id: "at_changev5",
  title: "Change in velocity from an a\u2013t graph (5)",
  prompt: "<p>An object has constant acceleration \\(a=1.5\\text{ m s}^{-2}\\) for 6 s.</p><p>Find the change in velocity.</p>",
  answer: "<p>Change in velocity = area under a\u2013t = \\(1.5\\times 6 = 9\\text{ m s}^{-1}\\).</p>",
  category: "graphs-acceleration-time",
  difficulty: "foundation",
...
{
  id: "at_changev6",
  title: "Change in velocity from an a\u2013t graph (6)",
  prompt: "<p>An object has constant acceleration \\(a=1.5\\text{ m s}^{-2}\\) for 6 s.</p><p>Find the change in velocity.</p>",
  answer: "<p>Change in velocity = area under a\u2013t = \\(1.5\\times 6 = 9\\text{ m s}^{-1}\\).</p>",
  category: "graphs-acceleration-time",
  difficulty: "foundation",
...
{
  id: "at_changev7",
  title: "Change in velocity from an a\u2013t graph (7)",
  prompt: "<p>An object has constant acceleration \\(a=1.5\\text{ m s}^{-2}\\) for 6 s.</p><p>Find the change in velocity.</p>",
  answer: "<p>Change in velocity = area under a\u2013t = \\(1.5\\times 6 = 9\\text{ m s}^{-1}\\).</p>",
  category: "graphs-acceleration-time",
  difficulty: "foundation",
...
{
  id: "at_piecewise_1",
  title: "Sketch a\u2013t from v\u2013t (concept)",
  prompt: "<p>A v\u2013t graph has these sections:</p><ul><li>0\u20135 s: straight line increasing</li><li>5\u20139 s: straight line decreasing</li><li>9\u201312 s: horizontal</li></ul><p>Describe the corresponding acceleration\u2013time graph (sign and whether constant).</p>",
  answer: "<p>Acceleration is slope of v\u2013t:</p><ul><li>0\u20135 s: constant positive acceleration</li><li>5\u20139 s: constant negative acceleration</li><li>9\u201312 s: zero acceleration</li></ul>",
  category: "graphs-acceleration-time",
  difficulty: "standard",
  marks: 3,
  skills: ["slope", "sketch"]
...

{
  id: "suvat_van",
  title: "Van skids to a halt",
  prompt: "<p>A van skids to a halt from an initial speed of \\(24\\text{ m s}^{-1}\\) covering a distance of 36 m. Assume constant acceleration.</p><p>Find (i) the acceleration (ii) the time to stop.</p>",
  answer: "<p>Use \\(v^2=u^2+2as\\): \\(0=24^2+2a(36)\\Rightarrow a=-\\frac{576}{72}=-8\\text{ m s}^{-2}\\).</p><p>Then \\(v=u+at\\): \\(0=24-8t\\Rightarrow t=3\\text{ s}\\).</p>",
  category: "suvat",
  difficulty: "standard",
  marks: 3,
  skills: ["SUVAT"]
...
{
  id: "suvat_train",
  title: "Train journey (multi-stage)",
  prompt: "<p>A train accelerates from rest to \\(17\\text{ m s}^{-1}\\) in 60 s, travels at \\(17\\text{ m s}^{-1}\\) for 60 s, then slows uniformly. After 45 s of slowing it is at \\(10\\text{ m s}^{-1}\\).</p><p>Find (a) the deceleration during slowing (b) the distance traveled during the 45 s slowing part.</p>",
  answer: "<p>(a) \\(a=\\frac{10-17}{45}=-\\frac{7}{45}\\approx -0.156\\text{ m s}^{-2}\\).</p><p>(b) Use average speed for uniform accel: \\(s=\\frac{(u+v)}{2}t=\\frac{(17+10)}{2}\\times 45=13.5\\times 45=607.5\\text{ m}\\).</p>",
  category: "suvat",
  difficulty: "challenge",
  marks: 6,
  skills: ["average speed", "uniform accel"]
},

{
  id: "suvat_skier",
  title: "Skier down slope",
  prompt: "<p>A skier starts with speed \\(2\\text{ m s}^{-1}\\) and after 10 s is moving at \\(6\\text{ m s}^{-1}\\) with constant acceleration.</p><p>(i) Find \\(v(t)\\).</p><p>(ii) Find \\(s(t)\\) from the start.</p><p>(iii) If the slope is 400 m, find speed at the bottom.</p>",
  answer: "<p>Acceleration \\(a=\\frac{6-2}{10}=0.4\\text{ m s}^{-2}\\).</p><p>(i) \\(v(t)=2+0.4t\\).</p><p>(ii) \\(s(t)=\\int v\\,dt = \\int(2+0.4t)dt = 2t+0.2t^2\\) (with \\(s(0)=0\\)).</p><p>(iii) Solve \\(2t+0.2t^2=400\\Rightarrow 0.2t^2+2t-400=0\\Rightarrow t^2+10t-2000=0\\). Positive root \\(t=\\frac{-10+\\sqrt{8100}}{2}=40\\) s. Then \\(v=2+0.4(40)=18\\text{ m s}^{-1}\\).</p>",
  category: "suvat",
  difficulty: "challenge",
  marks: 6,
  skills: ["model", "solve quadratic"]
},

{
  id: "calc_poly",
  title: "Particle motion: x=t^3-5t^2+4",
  prompt: "<p>The motion of a particle is given by \\(x=t^3-5t^2+4\\).</p><p>(a) Find \\(v(t)\\).</p><p>(b) Find initial position and velocity.</p><p>(c) Find times when velocity is zero and the corresponding positions.</p>",
  answer: "<p>(a) \\(v=\\frac{dx}{dt}=3t^2-10t=t(3t-10)\\).</p><p>(b) At \\(t=0\\): \\(x(0)=4\\), \\(v(0)=0\\).</p><p>(c) \\(v=0\\Rightarrow t=0\\) or \\(t=\\frac{10}{3}\\). Positions: \\(x(0)=4\\). \\(x(10/3)=\\left(\\frac{10}{3}\\right)^3-5\\left(\\frac{10}{3}\\right)^2+4=\\frac{1000}{27}-\\frac{500}{9}+4=\\frac{1000-1500+108}{27}=-\\frac{392}{27}\\).</p>",
  category: "calculus",
  difficulty: "challenge",
  marks: 6,
  skills: ["differentiate", "solve", "substitute"]
},

{
  id: "calc_brake",
  title: "Braking model v=40-2t^2",
  prompt: "<p>During braking a car\u2019s speed is modeled by \\(v=40-2t^2\\) until it stops.</p><p>(i) How long does it take to stop?</p><p>(ii) How far does it move before it stops?</p>",
  answer: "<p>(i) Stop when \\(v=0\\Rightarrow 40-2t^2=0\\Rightarrow t^2=20\\Rightarrow t=\\sqrt{20}=2\\sqrt{5}\\) s.</p><p>(ii) Distance \\(=\\int_0^{2\\sqrt{5}} (40-2t^2)dt = \\left[40t-\\frac{2}{3}t^3\\right]_0^{2\\sqrt{5}} = 80\\sqrt{5}-\\frac{2}{3}(8\\cdot 5\\sqrt{5})=80\\sqrt{5}-\\frac{80}{3}\\sqrt{5}=\\frac{160}{3}\\sqrt{5}\\) m.</p>",
  category: "calculus",
  difficulty: "challenge",
  marks: 6,
  skills: ["integrate", "model"]
},

{
  id: "mixed_1",
  title: "From v\u2013t to a\u2013t sketch",
  prompt: "<p>A velocity\u2013time graph consists of 3 straight-line sections: rising from 0 to 4 m/s in 2 s, constant at 4 m/s from 2\u20136 s, then falling uniformly to 0 m/s by 10 s.</p><p>(a) Find acceleration in each section.</p><p>(b) Sketch the acceleration\u2013time graph.</p>",
  answer: "<p>(a) 0\u20132: \\(a=\\frac{4-0}{2}=2\\). 2\u20136: \\(a=0\\). 6\u201310: \\(a=\\frac{0-4}{4}=-1\\).</p><p>(b) a\u2013t is three horizontal lines at 2, 0, and -1 over those intervals.</p>",
  category: "mixed",
  difficulty: "standard",
  marks: 6,
  skills: ["slope", "sketch"]
...
{
  id: "mixed_2",
  title: "Distance from a\u2013t (two stages)",
  prompt: "<p>An object starts from rest. It accelerates at \\(3\\text{ m s}^{-2}\\) for 4 s, then continues at constant velocity for 6 s.</p><p>Find total distance in 10 s.</p>",
  answer: "<p>After 4 s: \\(v=at=12\\text{ m s}^{-1}\\). Distance in first 4 s: \\(s=\\frac{1}{2}at^2=\\frac{1}{2}\\cdot 3\\cdot 16=24\\) m.</p><p>Next 6 s at 12 m/s: distance \\(=12\\cdot 6=72\\) m. Total \\(=96\\) m.</p>",
  category: "mixed",
  difficulty: "standard",
  marks: 6,
  skills: ["SUVAT", "piecewise"]
}
];
...
function formatCategory(cat){
  const map = {
    "graphs-distance-time":"Distance–Time Graphs",
    "graphs-velocity-time":"Velocity–Time Graphs",
    "graphs-acceleration-time":"Acceleration–Time Graphs",
    "suvat":"SUVAT / Constant Acceleration",
    "calculus":"Differentiation & Integration",
    "mixed":"Mixed Exam-Style"
  };
      ...
      card.innerHTML = `
        <header class="problem-header">
          <div class="problem-meta">
            ...
            <span class="pill">${p.marks||3} pts</span>
            <span class="pill muted">${formatCategory(p.category)}</span>
          </div>
